...
const authHandler = require(path.join(__dirname, 'api', 'auth.js'));
const menuHandler = require(path.join(__dirname, 'api', 'menu.js'));
const ordersHandler = require(path.join(__dirname, 'api', 'orders.js'));
const statusHandler = require(path.join(__dirname, 'api', 'canteen-status.js'));
const noticesHandler = require(path.join(__dirname, 'api', 'notices.js'));
